  ...
  return (
    <div>
      <ul>
        ...
        <li><Link id='dif' to=""><CameraAltIcon className='camera' onClick={showProfileModal} /><img src={profile} className="imges" alt="profile" />
          <ul class="dropdown">

            <li>
              <Link to="" onClick={showModal}> Chnage Password </Link>
            </li>
